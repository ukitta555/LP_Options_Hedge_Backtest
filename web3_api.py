...
web3_api_url = f'https://eth-mainnet.g.alchemy.com/v2/{ALCHEMY_WEB3_KEY}'

w3 = Web3(Web3.HTTPProvider(web3_api_url))



def fetch_token_decimals(token_address: str):
    payload = {
        "id": 1,
        "jsonrpc": "2.0",
...
def fetch_pool_address(token_0_address: str, token_1_address: str, bips: int):
